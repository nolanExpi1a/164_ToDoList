    ...
    if request.method == "POST":
        try:
            if form_add_film.validate_on_submit():
                ...
                strsql_insert_film = """INSERT INTO t_calendrier (id_film,nom_film) VALUES (NULL,%(value_nom_film)s) """
...
def film_update_wtf():
    ...
    try:
        ...
        if request.method == "POST" and form_update_film.submit.data:
            ...
            str_sql_update_nom_film = """UPDATE t_calendrier SET nom_film = %(value_nom_film)s,
            ...
            str_sql_id_film = "SELECT * FROM t_calendrier WHERE id_film = %(value_id_film)s"
...
def film_delete_wtf():
    ...
    try:
        ...
        if form_delete_film.submit_btn_del_film.data:
            ...
            str_sql_delete_fk_film_genre = """DELETE FROM t_calendrier WHERE fk_film = %(value_id_film)s"""
            str_sql_delete_film = """DELETE FROM t_calendrier WHERE id_film = %(value_id_film)s"""
        ...
        if request.method == "GET":
            ...
            str_sql_genres_films_delete = """SELECT * FROM t_calendrier WHERE id_film = %(value_id_film)s"""
